...
public class BolaoActivity extends AppCompatActivity {
    ...
    static String TAG = BolaoActivity.class.getName();
    private List<Bolao> boloesGerenciados = new ArrayList<>();

    ListView listByOwner;
    ArrayAdapter<Bolao> adapterByOwner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Gerenciados por mim");
        ...
        listByOwner = (ListView) findViewById(R.id.listViewGerenciados);
        preencheGerenciados();
    }
    ...
    private void preencheGerenciados() {
        ...
        try {
            ...
            String url = getString(R.string.url_base) + "/bolao/findByOwner/" + email;
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    boloesGerenciados.add(b);
                                    adapterByOwner = new ArrayAdapter<Bolao>(BolaoActivity.this,
                                            android.R.layout.simple_list_item_1, boloesGerenciados);
    ...
    private void showDialog(String title, String message) {
        AlertDialog alertDialog = new AlertDialog.Builder(BolaoActivity.this).create();
...
/*            Intent intent = new Intent(NavigationActivity.this, BolaoActivity.class);
    ...
    public void logout(View view) {
        ...
        Intent intent = new Intent(BolaoActivity.this, LoginActivity.class);
        startActivity(intent);
    }
